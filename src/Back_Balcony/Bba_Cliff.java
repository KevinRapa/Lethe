...
/* CONSTRUCTOR ---------------------------------------------------------------*/    
    public Bba_Cliff() {
        ...
        this.actDialog = "You haven't reached that point yet.";
        this.searchDialog = "You aren't jumping down there like that last person did.";
...
//-----------------------------------------------------------------------------
    @Override public String interact(String key) {
        if (key.equals("jump"))
            ...
            return "You're too heavy for that, and the cliff is too vertical.";
    }
//-----------------------------------------------------------------------------
}