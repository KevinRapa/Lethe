...
/* CONSTRUCTOR ---------------------------------------------------------------*/     
    public Stud_BookPhy(String name) {
        ...
        pg1 = "- A Young Mind's Guide to Lichery -\n" +
              "- by Melroth Gfrorgozh -\n\n        "
            + "Let this be a sequel to 'A Young Mind's Guide\n" +
        ...
        pg2 = "Before you begin, have your materials in order.\n" +
        ...
        pg3 = "The resulting vapor should be collected in a vacuum\n" +
