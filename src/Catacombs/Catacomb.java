...
// ============================================================================    
    public Catacomb(String ID) {
        ...
        */
        ...
        // For each adjacent room, determines if its a catacomb or not.
        // Adds its X and Y coordinates to adjOtherCoords or adjCatacombCoords
        for (String i : this.adjacent) {
            int[] coords = {i.charAt(2) - '0', i.charAt(3) - '0'};
            if (i.matches("CT\\d\\d")) 
