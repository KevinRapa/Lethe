 ...
 * @author Kevin Rapa
 */
public class Sew5_Vlv extends Furniture {
    private final Sew4_Pp SEW4PP;
    private final Sew2_Vlvs SEW2VLVS;
    // ========================================================================
    public Sew5_Vlv (Furniture sew2Vlvs, Furniture sew4Pp) {
        super();
        
        this.SEW2VLVS = (Sew2_Vlvs)sew2Vlvs;
        this.SEW4PP = (Sew4_Pp)sew4Pp;
    ...
    @Override public String interact(String key) {              
        if (! SEW4PP.isMissingPipe() && SEW2VLVS.solved()) {
            ((Cis1)Player.getRoomRef("CIS1")).turnOffGas();
        }
