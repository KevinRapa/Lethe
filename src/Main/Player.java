...
public class Player implements Serializable {
    ...
    private String shoesWearing; // Name of the shoes the player is wearing;
    //========================================================================== 
    /**
...
//******************************************************************************
    ...
    /*------------------------------------------------------------------------*/
    public String shoes() {
        return this.shoesWearing;
    }
    /*------------------------------------------------------------------------*/
    public void switchShoes(String shoes) {
        this.shoesWearing = shoes;
    }
//******************************************************************************    
// </editor-fold>  
//******************************************************************************
...
//******************************************************************************
    ...
    public int startDialog(Room[][][] map) {
        AudioPlayer.playTrack(this.occupies.getID());
...
//******************************************************************************    
    ...
    private void move(char dir, Room[][][] map) {  
        ...
        if (! this.occupies.isAdjacent(destination.getID()))
            ...
            if (occupies.isThisLocked() && ! this.VISITED.contains(occupies.getID()))
                // Plays unlock sound if room is locked and you haven't been to the room before.
                AudioPlayer.playEffect(13);
            
            else if (! occupies.getID().substring(0,3).matches(lastVisited.substring(0, 3)))
                // Plays door sound if moving between two rooms. Two rooms have
                // a door between them if the first three characters of their ID
                // are identical.
                AudioPlayer.playEffect(9); 
            else
                // Plays footsteps instead of the door sound.
