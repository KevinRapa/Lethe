...
public class Salamaa {
    ...
    public static Room[][][] createMap() {
        ...
        Furniture cou1F = new cou1_Flr(cou1Hl);
        ...
        Furniture closShlf = new Gqua_Shlf("shelf", bckt, closGlv, vial, shvl);
        ...
        //-----------------------------FURNITURE-------------------------------- 
        Furniture searFssr = new Sear_Fssr(cous, brWrHmr);
        ...
        Furniture din1Tpstry = new Din1_Tpstry(aphrdtPlt);
        ...
        Furniture eow2Wtr = new Water(wtrBckt);
        ...
        //-----------------------------FURNITURE--------------------------------
        Furniture kitcTrch = new Kitc_Trch(hndTrch, kitc);
        ...
        Furniture par2Shlf = new Wow3_Shlf(vial, parNt, gaeaPlt);
        ...
        Furniture bha2Frm = new Bha2_Frm(gal5CbtKey);
