...
//-----------------------------------------------------------------------------    
    public Wall(String dsc) {
        ...
        this.actDialog = "What do you expect to find? A pork chop?";
        this.searchDialog = "The walls here are solid and couldn't hide anything.";
        this.useDialog = "You whack the wall and jolt backwards.";
...
//-----------------------------------------------------------------------------
    @Override public String interact(String key) {
        if (key.equals("break"))
            ...
            return "Your player casually leans on the wall with no surprise.";
        else
            return "Suction cups would be nice right now.";
    }
//-----------------------------------------------------------------------------
}
