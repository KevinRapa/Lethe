...
import static A_Main.Patterns.CHEMICAL_P;
/**
 ...
 * @author Kevin Rapa
 */
public class Labo_DryIce extends SearchableFurniture implements Openable, Heavy {
    ...
    // ========================================================================
        @Override public boolean add(Item item) {
            ...
            if (CHEMICAL_P.matcher(item.toString()).matches()) {
        ...
        public void reOpen(boolean interrupted) {
            if (! interrupted && BARREL_INV.contains(BROMINE)) {
                ...
                BARREL_INV.add(new Ingredient("chilled " + 
                    ITEM_NAME, "The chemical feels cold to the touch.", 0));   
            }
