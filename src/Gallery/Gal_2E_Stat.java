...
/* CONSTRUCTOR ---------------------------------------------------------------*/    
    public Gal_2E_Stat(Furniture stat) {
        super();
...
/*----------------------------------------------------------------------------*/
    public String activate(char color, boolean isOn) {
        ...
        if (Player.getRoomRef("GAL4").hasFurniture("statue") && isOn && this.level != 3) {
        ...
        else if (Player.getRoomRef("GAL4").hasFurniture("statue") && this.level == 3 && isOn)
...
/*----------------------------------------------------------------------------*/
    private String raise() {
        switch (level++) {
            ...
            default: 
                Player.getRoomRef("GAL7").addFurniture(STAT_REF);
