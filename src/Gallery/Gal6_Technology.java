...
/* CONSTRUCTOR ---------------------------------------------------------------*/    
    public Gal6_Technology() {
        ...
        this.description = "Wow! So much cool technology! This sure beats coal and steam.";
        this.searchDialog = "You can't decide which thing to search first.";
        this.useDialog = "You would have no idea what to do. This stuff is foreign to you.";
