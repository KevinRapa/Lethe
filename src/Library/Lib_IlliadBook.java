...
public class Lib_IlliadBook extends Book {
/* CONSTRUCTOR ---------------------------------------------------------------*/      
    public Lib_IlliadBook(String name) {
        super(name, 4);
        
        PAGE_LIST[0] = "The Iliad is an epic poem originally written in Homerian " +
        ...
        PAGE_LIST[1] = "Sing, O goddess, the anger of Achilles son of Peleus, that " +
        ...
        PAGE_LIST[2] = "\"Sons of Atreus,\" he cried, \"and all other Achaeans, may " +
        ...
        PAGE_LIST[3] = "Thus did he pray, and Apollo heard his prayer. He came down " +
