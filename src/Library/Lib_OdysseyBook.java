...
public class Lib_OdysseyBook extends Book {
    public Lib_OdysseyBook(String name) {
        super(name, 4);
        
        PAGE_LIST[0] = "The Odyssey is an epic poem originally written in Homerian " +
                       "Greek by the eponymous Homer. It tells the story of Odysseus, " +
                       "after the Trojan War, and his voyage home to Ithaca. ";
        
        PAGE_LIST[1] = "Tell me, O muse, of that ingenious hero who travelled far and wide " +
                       ...
                       "his troubles were not yet over; nevertheless all the gods had now " +
                       "begun to pity him except Neptune, who still persecuted him without " +
                       "ceasing and would not let him get home.";
        
        PAGE_LIST[2] = "Now Neptune had gone off to the Ethiopians, who are at the world's " +
                       ...
                       "by Agamemnon's son Orestes; so he said to the other gods: " +
                       ...
                       "Mercury told him this in all good will but he would not listen, and " +
                       "now he has paid for everything in full.\"";
        
        PAGE_LIST[3] = "Then Minerva said, \"Father, son of Saturn, King of kings, it served " +
                       ...
                       "sea-king Phorcys; therefore though he will not kill Ulysses outright, " +
                       "he torments him by preventing him from getting home. Still, let us lay " +
                       "our heads together and see how we can help him to return; Neptune will " +
