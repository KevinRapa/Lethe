...
public class Lib_GenesisBook extends Book {
/* CONSTRUCTOR ---------------------------------------------------------------*/      
    public Lib_GenesisBook(String name) {
        super(name, 4);
        
        PAGE_LIST[0] = "The Book of Genesis is the first chapter in the Old Testament of " +
                       "the Christian Bible. This book narrates the creation of the world " +
                       "along with the first man and woman by God.";
        
        PAGE_LIST[1] = "In the beginning when God created the heavens and the earth, " +
                       ...
                       "So God made the dome and separated the waters that were under " +
        ...
        PAGE_LIST[2] = "[1:11] Then God said, \"Let the earth put forth vegetation: plants " +
                       ...
                       "and let them be lights in the dome of the sky to give light upon " +
        ...
        PAGE_LIST[3] = "So God created the great sea monsters and every living creature that " +
