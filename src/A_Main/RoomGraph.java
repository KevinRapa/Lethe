 ...
 * room to fetch its own coordinates and adjacent rooms by passing its ID in.
 * The hash maps in this class populate themselves with constructRoomGraph. 
 * @author Kevin Rapa 
 ****************************************************************************/ 

public class RoomGraph { 
    private static final HashMap<String, String[]> 
            ADJACENTS = new HashMap<>(); // Maps IDs to a list of adjacent rooms.
    
    private static final HashMap<String, int[]> 
            COORDINATES = new HashMap<>(); // Maps IDs to coordinates.
     ...
     */
    public static String getRoomID(int ... c) {
        // Converts the array to a base 10 number to use as an index.
        int baseTen = (c[0] * 100) + (c[1] * 10) + c[2];
        String result = INT_TO_ID.get(baseTen);
        return (result == null) ? Id.NULL : result;
    }
    //-------------------------------------------------------------------------
}