...
public final class Patterns {
    ...
    public static final Pattern
        YES_P = Pattern.compile("y|yes"),    
        NO_P = Pattern.compile("n|no"),
        WORD_P = Pattern.compile("[a-z]+"),
        ...
        USE_P = Pattern.compile("use|read|drop|wear|remove|eat|drink|throw|lean|tie"),
        USE_ITEM_CMD_P = Pattern.compile("(?:" + USE_P + "|" + INSPECT_P + ") [a-z0-9: ,'-]+"),
        SUICIDE_P = Pattern.compile("commit suicide|(?:kill|hang) (?:your)?self"),
        DESTROY_P = Pattern.compile("(?:destroy|shatter|obliterate|wreak havoc|throw) .+"),
        STORE_CMD_P = Pattern.compile("(?:put|store|pour|dump) [a-z0-9: ,'-]+"),
        STORE_SPACE_P = Pattern.compile("(?:put|store|pour|dump) "),
        PREPOS_P = Pattern.compile("up|down|(?:in|on)(?:to)?|out|off|over|of|through|against|from|around|to|at|under(?:neath)?"),
        NUMBER_P = Pattern.compile("[0-9]+"),
